...
try {
    em++ $mainPath -s WASM=1 -s MODULARIZE=1 -s EXPORT_ES6=1 -s EXPORTED_FUNCTIONS=$funcToExport -s EXPORTED_RUNTIME_METHODS='["cwrap", "ccall", "HEAP32"]' -o "$outputPath\$outputFilename"
